...
export default function InvoiceDetailScreen() {
  ...
  const handleSend = () => {
    ...
    // In a real app you\'d use Linking.openURL(mailto); here we alert for now
    Alert.alert("Send Invoice", `Open email app to send to ${client.email}?`, [
      { text: "Cancel", style: "cancel" },
      { text: "Send", onPress: () => console.log("Mailto:", mailto) },
    ]);
  };
      ...
      <View style={styles.card}>
        ...
        <View style={styles.clientRow}>
          ...
          <Text style={styles.clientValue}>
            {client
              ? `${client.full_name}${client.partner_name ? ` & ${client.partner_name}` : ""}`
              : "Unknown Client"}
          </Text>
        </View>
        {client?.email && (
          ...
          <>
            ...
            <View style={styles.detailRow}>
              ...
              <Text style={styles.detailValue}>
                {invoice.due_date ? new Date(invoice.due_date).toLocaleDateString("en-AU") : "Not set"}
              </Text>
            </View>
            <View style={styles.detailRow}>
