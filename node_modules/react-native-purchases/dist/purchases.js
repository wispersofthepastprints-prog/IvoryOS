...
var Purchases = /** @class */ (function () {
    ...
    Purchases.configure = function (configuration) {
        var _a;
        var apiKey = configuration.apiKey, _b = configuration.appUserID, appUserID = _b === void 0 ? null : _b, _c = configuration.purchasesAreCompletedBy, purchasesAreCompletedBy = _c === void 0 ? purchases_typescript_internal_1.PURCHASES_ARE_COMPLETED_BY_TYPE.REVENUECAT : _c, userDefaultsSuiteName = configuration.userDefaultsSuiteName, _d = configuration.storeKitVersion, storeKitVersion = _d === void 0 ? purchases_typescript_internal_1.STOREKIT_VERSION.DEFAULT : _d, _e = configuration.useAmazon, useAmazon = _e === void 0 ? false : _e, _f = configuration.shouldShowInAppMessagesAutomatically, shouldShowInAppMessagesAutomatically = _f === void 0 ? true : _f, _g = configuration.entitlementVerificationMode, entitlementVerificationMode = _g === void 0 ? purchases_typescript_internal_1.ENTITLEMENT_VERIFICATION_MODE.DISABLED : _g, _h = configuration.pendingTransactionsForPrepaidPlansEnabled, pendingTransactionsForPrepaidPlansEnabled = _h === void 0 ? false : _h, _j = configuration.diagnosticsEnabled, diagnosticsEnabled = _j === void 0 ? false : _j, _k = configuration.automaticDeviceIdentifierCollectionEnabled, automaticDeviceIdentifierCollectionEnabled = _k === void 0 ? true : _k, preferredUILocaleOverride = configuration.preferredUILocaleOverride, dangerousSettings = configuration.dangerousSettings;
        var _l = configuration, store = _l.store, galaxyBillingMode = _l.galaxyBillingMode;
